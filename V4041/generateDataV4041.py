...
objectDistance1 = np.array([22, 17.2, 38.5]) * 1e-2
...
objectDistance2 = np.array([58.5, 39.5, 65.8]) * 1e-2  # cm -> m
...
# _____________________________________________________________________________
# Part 2: two collecting lenses together, refractivity D3 = 12.52 dpt
# distance between lenses = 2.8 cm
objectDistance3 = 0.173
imageDistance3 = getImageDistance(objectDistance3, 12.52, 0.02)
# save it in [cm]
np.save(workingDir + "Data" + experiment + "Part2",
        np.round(np.array([objectDistance3 * 1e2, imageDistance3 * 1e2], dtype=np.float), 1))

# _____________________________________________________________________________
# Part 3: diffuser lens D=-7 dpt
# combined with lens 1, refractivity D4 = 10-7=3 dpt
# distance between lenses = 3.0 cm
objectDistance4 = 0.50
imageDistance4 = getImageDistance(objectDistance4, 3, 0.08)
